...
$installFile = $random_folder + "setupdownloader_[aHR0cHM6Ly9jbG91ZGd6LWVjcy5ncmF2aXR5em9uZS5iaXRkZWZlbmRlci5jb20vUGFja2FnZXMvQlNUV0lOLzAvcEl3QjJjL2luc3RhbGxlci54bWw-bGFuZz1lbi1VUw==].exe"

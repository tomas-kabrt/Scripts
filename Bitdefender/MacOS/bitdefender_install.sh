...
if [ "$arch_name" = "x86_64" ]; then
    # "Running on Intel"
    dl_link="https://cloudgz.gravityzone.bitdefender.com/Packages/MAC/0/Pl7RQo/Bitdefender_for_MAC.dmg"
    pkg_name="antivirus_for_mac.pkg"
elif [[ "$arch_name" =~ "arm" ]]; then
    # "Running on ARM"
    dl_link="https://cloudgz.gravityzone.bitdefender.com/Packages/MAC/0/Pl7RQo/Bitdefender_for_MAC_ARM.dmg"
